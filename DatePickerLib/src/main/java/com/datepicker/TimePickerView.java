...
import com.datepicker.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private ImageView btnCancel; //确定、取消按钮
    ...
    public static class Builder {
        ...
        private boolean[] type = new boolean[]{true, true, false, false, false, false};//显示类型 默认全部年月日
        private int gravity = Gravity.CENTER;//内容显示位置 默认居中
    ...
    private void initView(Context context) {
        ...
        wheelTime.setLineHeight(mItemHeight);
    }
