...
public class WheelTime {
    ...
    private static final int DEFAULT_END_YEAR = 2024;
    ...
    private void setItemHeight() {
        wv_day.setLineHeight(mLineHeight);
        wv_month.setLineHeight(mLineHeight);
        wv_year.setLineHeight(mLineHeight);
        wv_hours.setLineHeight(mLineHeight);
        wv_mins.setLineHeight(mLineHeight);
        wv_seconds.setLineHeight(mLineHeight);
    }
